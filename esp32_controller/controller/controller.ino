...
#define WATERLVLSENSORMEZMIN 25
#define WATERLVLSENSORMEZMAX 33
...
int manualORauto = 1;       // (bombas) 0 = automatico, 1 = manual
int manualORautoLed = 1;    // (led) 0 = automatico, 1 = manual
int manualORautoFan = 1;    // (ventilador) 0 = automatico, 1 = manual
int manualORautoHeater = 1; // (calefactor) 0 = automatico, 1 = manual
int powerLed = 0;
int powerFan = 0;
int powerHeater = 0;
...
void sendData()
{
    if (WiFi.status() == WL_CONNECTED)
    {
        ...
        Serial.println(
            ...
            String("pH: ") + String(dataSensorsInfo[0]) + ", " +
            String("TDS: ") + String(dataSensorsInfo[1]) + ", " +
            String("Temp: ") + String(dataSensorsInfo[2]) + ", " +
            String("Humidity: ") + String(dataSensorsInfo[3]) + ", " +
            String("Light Resistor: ") + String(dataSensorsInfo[4]) + ", " +
            String("Light Sensor: ") + String(dataSensorsInfo[6]) + ", " +
            String("Water Level Min Plan: ") + String(dataSensorsInfo[5]) + ", " +
...
void setup()
{
    ...
    pinMode(WATERLVLSENSORMAX, INPUT_PULLDOWN);
